#include "ru_arvalon_chapter9_NativeThreadsActivity.h"
#include "./thread.h"
#include <iostream>
#include <sstream>
#include <ctime>
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    gVm = vm;
    cpuStatClass = (jclass) env->NewGlobalRef(env->FindClass("ru/arvalon/chapter9/JCPUStat"));
...
void Java_ru_arvalon_chapter9_NativeThreadsActivity_startNativeThreads
