...
jlong Java_ru_arvalon_chapter9_JCPUStat_getRSSMemory(JNIEnv *env, jobject obj) {
...
void Java_ru_arvalon_chapter9_JCPUStat_dispose(JNIEnv *env, jobject obj) {
...
void Java_ru_arvalon_chapter9_StatsActivity_startCPUStatThread(JNIEnv *env, jobject activity) {
...
void Java_ru_arvalon_chapter9_StatsActivity_stopCPUStatThread(JNIEnv *, jobject activity) {
